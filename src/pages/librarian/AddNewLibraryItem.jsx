        ...
        loading ? <Loading /> : <section className='!p-0'>
            <form onSubmit={submitHandler} action="" className='bg-white p-[16px] rounded-lg flex flex-col gap-[4px]'>
                ...
                <label htmlFor="">
                    ...
                    <Select options={libraryItemCategories} placeholder="Choose Category" styles={styles} value={category} onChange={setCategory} />
                </label>
                ...
                <label htmlFor="">
                    ...
                    <input type="text" placeholder='Enter Edition' value={edition} onChange={(e) => setEdition(e.target.value)} />
                </label>
                ...
                <label htmlFor="">
                    ...
                    <input type="text" placeholder='Enter Publisher Code' value={publisherCode} onChange={(e) => setPublisherCode(e.target.value)} />
                </label>
                ...
                <label htmlFor="">
                    ...
                    <input type="file" placeholder='Enter Copyright' onChange={changeImageHandler} />
                </label>

                <button className='primary-btn !w-full inline-block mt-[4px]'>Submit</button>
            </form>
        </section>
    )
}
